...
import { logo, banner2 } from '../Images'
...
function Contact() {
  ...
  <section class="mb-32">
    <div class="relative h-[300px] w-auto overflow-hidden object-contain bg-cover bg-[50%] bg-no-repeat bg-[url('https://drive.google.com/uc?export=view&id=1OicBdZosCDdTuGcKLvwQFuL_2u43mQO5')]"></div>
        ...
        <div class="flex flex-wrap">
          <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
            <form>
              ...
              <Button type="submit" classname="mb-6 inline-block w-full rounded  px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal   lg:mb-0">
                Send
              </Button>
            </form>
          </div>
            ...
            <div class="flex flex-wrap">
              ...
              <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
                <div class="flex items-start">
                  ...
                  <div class="ml-6 grow">
                    <p class="mb-2 font-bold dark:text-white">
                      Club Related Questions and Tech Support
                    </p>
                    <p class="text-neutral-500 dark:text-neutral-200">
              ...
              <div
                ...
                <div class="align-start flex">
                  ...
                  <div class="ml-6 grow">
                    <p class="mb-2 font-bold dark:text-white">Sponsorship Approach</p>
                    <p class="text-neutral-500 dark:text-neutral-200">
                      subhashishgorai57@gmail.com
                    </p>
                    <p class="text-neutral-500 dark:text-neutral-200">
                      +91 9470557727
                    </p>
